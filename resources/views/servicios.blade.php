                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-inverse table-responsive" id="tableservicios">
                            <thead class="thead-inverse">
                                <tr>
                                    <th><button type="button" data-toggle="modal" data-target="#modalagregarservicio"
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-headingOne">
                                                    <button class="accordion-button collapsed" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#flush-servicio{{$servicio->id}}"
                                                        aria-expanded="false" aria-controls="flush-collapseOne">
                                                        Opciones
                                                    </button>
                                                </h2>
                                                <div id="flush-servicio{{$servicio->id}}" class="accordion-collapse collapse"
                                                    aria-labelledby="flush-headingOne"
                                                    data-bs-parent="#accordionFlushExample">
                                                    <div class="accordion-body"> <a href="" data-toggle="modal"
