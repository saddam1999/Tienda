        ...
        <table class="table table-striped table-inverse table-responsive" id="tablecajas">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$caja->corte}}</td>
                    <td>{{$caja->id_corte}}</td>
                    <td><a href="" data-toggle="modal" data-target="#modaleditarcaja" data-id="{{$caja->id}}"
                            data-id_user="{{$caja->id_user}}" data-id_sucursal="{{$caja->id_sucursal}}"
                            data-id_corte="{{$caja->id_corte}}" data-status="{{$caja->status}}" <svg width="1em"
                        ...
                        <a href="/deletecaja/{{$caja->id}}"><svg width="1em" height="1em" viewBox="0 0 16 16"
