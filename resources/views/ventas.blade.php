                        ...
                        <table class="table table-striped table-inverse table-responsive" id="tableventas">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="price">
                                        @php
                                        $dia1 = $pago_equipo->created_at->format("d");
                                        $mes = $pago_equipo->created_at->format("m");
                                        $ano = $pago_equipo->created_at->format("Y");
                                        if ($mes == 1) {
                                        $mes1 = 'Enero';
                                        } elseif ($mes == 2) {
                                        $mes1 = 'Febrero';
            ...
            <table class="table table-striped table-inverse table-responsive" id="tablemovimientos">
                <thead class="thead-inverse">
                    <tr>
                        ...
                        <th><button type="button" data-toggle="modal" data-target="#modal_caja" data-backdrop="static"
                                data-keyboard="false" class="btn btn-warning btn-lg btn-block">
                                <center><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-wallet2"
                            ...
                            <button type="button" data-toggle="modal" data-target="#modal_corte" data-backdrop="static"
                                data-keyboard="false" class="btn btn-info btn-lg btn-block">
                                <center><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-clipboard-data"
                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                             ...
                             @php
                            $dia1 = $MovimientoCaja->created_at->format("d");
                            $mes = $MovimientoCaja->created_at->format("m");
                            $ano = $MovimientoCaja->created_at->format("Y");
                            if ($mes == 1) {
                            $mes1 = 'Enero';
                            } elseif ($mes == 2) {
                            $mes1 = 'Febrero';
