...
<x-app-layout>
    ...
    <script data-require="datatables@1.10.12" data-semver="1.10.12"
    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul class="nav nav-tabs bg-ligth shadow-lg border border-secondary mt-5" id="myTab" role="tablist" id="blurrMe"
            id="trigger" style=" border: none; border-radius: 10px;">
            ...
            <li class="nav-item">
                <a class="nav-link" id="sucursal-tab" data-toggle="tab" href="#sucursal" role="tab"
                    aria-controls="sucursal" aria-selected="false"><svg width="1em" height="1em" viewBox="0 0 16 16"
            ...
            <li class="nav-item">
                <a class="nav-link" id="settings-tab" data-toggle="tab" href="#settings" role="tab"
                    aria-controls="settings" aria-selected="false"><svg width="1em" height="1em" viewBox="0 0 16 16"
        ...
        <div class="container-fluid">
            <div class="header fixed-header navbar-default navbar-fixed-top" role="navigation" >
                    <ul class="nav nav-pills pull-right">
                        <h3><li><a class="buttob btn-default" href="#" id="trigger">Menu <i class="fas fa-bars"></i></li></h3></a>
                    </ul>
                </i>
            ...
            <div class="sidebar closed"     style="background-image: url('../img/backgrounds.jpeg');">
                <header>
                    ...
                    <h2 class="text-white">@if($Settings->isEmpty()) @else{{$setting->setting_nombre}}@endif</h2> <a href="#" id="close"><span
                ...
                <ul class="nav nav-tabs bg-ligth shadow-lg border border-secondary mt-1  shadow-lg" id="myTab" role="tablist"
                    ...
                    <li class="nav-item rounded face" id="trigger">
                        <a class="nav-link" id="taller-tab" data-toggle="tab" href="#taller" role="tab"
                            aria-controls="taller" aria-selected="false"><svg width="1em" height="1em"
                                viewBox="0 0 16 16" class="bi bi-tools" fill="currentColor"
                    ...
                    <li class="nav-item rounded face" id="trigger">
                        <a class="nav-link" id="ventas-tab" data-toggle="tab" href="#ventas" role="tab"
                            aria-controls="ventas" aria-selected="false"><svg width="1em" height="1em"
                    ...
                    <li class="nav-item" id="trigger">
                        <a class="nav-link" id="usuarios-tab" data-toggle="tab" href="#usuarios" role="tab"
                            aria-controls="usuarios" aria-selected="false"><svg width="1em" height="1em"
                                viewBox="0 0 16 16" class="bi bi-people" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1h7.956a.274.274 0 0 0 .014-.002l.008-.002c-.002-.264-.167-1.03-.76-1.72C13.688 10.629 12.718 10 11 10c-1.717 0-2.687.63-3.24 1.276-.593.69-.759 1.457-.76 1.72a1.05 1.05 0 0 0 .022.004zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10c-1.668.02-2.615.64-3.16 1.276C1.163 11.97 1 12.739 1 13h3c0-1.045.323-2.086.92-3zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" />
                            </svg>Usuarios
                    ...
                    <li class="nav-item" id="trigger">
                        <a class="nav-link" id="sucursal-tab" data-toggle="tab" href="#sucursal" role="tab"
                            aria-controls="sucursal" aria-selected="false"><svg width="1em" height="1em"
                ...
                <li class="nav-item" id="trigger">
                        <a class="dropdown-item" id="articulos-tab" id="trigger" data-toggle="tab" href="#articulos"
                            role="tab" aria-controls="articulos" aria-selected="true">Articulos
                        </a>
                    </li>
                    <li class="nav-item" id="trigger">
                        <a class="dropdown-item" id="marcas-tab" id="trigger" data-toggle="tab" href="#marcas"
                            role="tab" aria-controls="marcas" aria-selected="false">Marcas
                        </a>
                    </li>
                    <li class="nav-item" id="trigger">
                    ...
                    <li class="nav-item" id="trigger">
                        <a class="dropdown-item trigger" id="servicios-tab" data-toggle="tab" href="#servicios"
                            role="tab" aria-controls="servicios" aria-selected="false">Area de Servicios
                        </a>
                    </li>
                    <li class="nav-item" id="trigger">
                    ...
                    <li class="nav-item" id="trigger">
                        <a class="dropdown-item trigger" id="categoria-tab" data-toggle="tab" href="#categoria"
                            role="tab" aria-controls="categoria" aria-selected="false">Categorias
                        </a>
                    </li>
<!--
                    <li class="nav-item" id="trigger">
                        <a class="nav-link" id="settings-tab" data-toggle="tab" href="#settings" role="tab"
                            aria-controls="settings" aria-selected="false"><svg width="1em" height="1em"
                                viewBox="0 0 16 16" class="bi bi-toggles2" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M2 4a2 2 0 0 1 2-2h8a2 2 0 1 1 0 4H4a2 2 0 0 1-2-2zm2-1a1 1 0 0 0 0 2h8a1 1 0 1 0 0-2H4z" />
                                <path d="M14 4a4 4 0 1 1-8 0 4 4 0 0 1 8 0z" />
            ...
            <div id="blurrMe">
                <div class="tab-content bg-black" id="myTabContent"
                    ...
                    <ul class="nav nav-tabs bg-ligth shadow-lg border border-secondary mt-1  shadow-lg" id="myTab" role="tablist"
                    id="blurrMe"style=" border: none;  border-radius: 10px;" data-backdrop="static" data-keyboard="false">
                    <li class="nav-item rounded face">
                        <a class="nav-link" id="taller-tab" data-toggle="tab" href="#taller" role="tab"
                            aria-controls="taller" aria-selected="false"><svg width="1em" height="1em"
                                viewBox="0 0 16 16" class="bi bi-tools" fill="currentColor"
...
-->
             ...
             <div class="col-md-4">
                 ...
                 <div class="input-group-prepend">
                     ...
                     if($equipo->status != 2 && $equipo->status != 6 && $equipo->id_sucursal ==
                     ...
                     @endphp
                     @endforeach
                     <a href="#" class="input-group-text  face notification" id="taller-tab" data-toggle="tab"
                         href="#taller" style="border-radius:10px;">
                                            ...
                                            <table class="table table-striped table-inverse table-responsive"
                                                ...
                                                <thead class="thead-inverse">
                                                    <tr>
                                                        ...
                                                        <th><button type="button" data-toggle="modal"
                                                                data-target="#modal_agregararticulo"
                                                                data-backdrop="static" data-keyboard="false"
                                                                class="btn btn-success btn-lg btn-block">
                                                                <center><svg width="1em" height="1em"
                                                                        viewBox="0 0 16 16" class="bi bi-clipboard-plus"
                                                                        fill="currentColor"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path fill-rule="evenodd"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <textarea name="" id="" cols="30" rows="10">{{$articulo->descripcion}}</textarea>
                                                        </td>
                        ...
                        <div class="py-12">
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style=" border: none;border-radius: 40px 10px;">
                                    <div class="card text-left">
                                        <div class="card-body">
                                            <h4 class="card-title">Marcas Sucursal @foreach ($Sucursal as
                                                $sucursal)@if($sucursal->id==Auth::user()->id_sucursal)
                                                {{$sucursal->nombre}} @endif @endforeach</h4>
                                            <table class="table table-striped table-inverse table-responsive"
                                                id="tablemarcas">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/deletemarca/{{$marca->id}}"><svg width="1em"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="" data-toggle="modal" data-target="#modaleditar"
                                                                ...
                                                                data-estatus="{{$usuario->status}}"><svg width="1em"
                                                            ...
                                                            <a href="/deleteusuario/{{$usuario->id}}"><svg width="1em"
                                                                    height="1em" viewBox="0 0 16 16" class="bi bi-trash"
                                                                    fill="currentColor"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                            ...
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style=" border: none; border-radius: 40px 10px;">
                                    <div class="card text-left">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">Servicios Sucursal @foreach ($Sucursal as
                                                $sucursal)@if($sucursal->id==Auth::user()->id_sucursal)
                                                {{$sucursal->nombre}} @endif @endforeach</h4>
                                            <table class="table table-striped table-inverse table-responsive"
                                                id="tableservicios">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="" data-toggle="modal"
                                                            ...
                                                            <a href="/deletecaja/{{$caja->id}}"><svg width="1em"
                                                                    height="1em" viewBox="0 0 16 16" class="bi bi-trash"
                                                                    fill="currentColor"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                            ...
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style=" border: none; border-radius: 40px 10px;">
                                    <div class="card text-left">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">Categorias Sucursal @foreach ($Sucursal as
                                                $sucursal)@if($sucursal->id==Auth::user()->id_sucursal)
                                                {{$sucursal->nombre}} @endif @endforeach</h4>
                                            <table class="table table-striped table-inverse table-responsive"
                                                id="tablecategoria">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="" data-toggle="modal"
                                                                data-target="#modal_editarcategoria"
                                                            ...
                                                            <a href="/deletecategoria/{{$categoria->id}}"><svg
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form
                                                                            ...
                                                                            <div class="row mt-2">
                                                                                <div class="col-md-6">
                                                                                    <label
                                                                                        for="setting_plantilla">Selecciona
                                                                                        Plantilla pagina
                                                                                        Principal:</label> <br>
                                                                                    <div
                                                                                        ...
                                                                                        <input class="form-check-input"
                                                                                            type="radio"
                                                                                            name="setting_plantilla"
                                                                                            id="setting_plantilla"
                                                                ...
                                                                <div class="card text-left">
                                                                    <div class="card-body">
                                                                        <form
                                                                            ...
                                                                            <label
                                                                                for="descuento_banner_principal">Descuento
                                                                                Banner
                                                                                Principal</label>
                                                                            <input class="form-control" type="text"
             ...
             <table class="table table-striped table-inverse table-responsive display nowrap" id="tabletaller">
                 ...
                 <tbody>
                     ...
                     <tr>
                         ...
                         <td>
                             <a href="" data-toggle="modal" data-target="#modaledittaller" data-id="{{$equipo->id}}"
                                 data-pago="{{$equipo->pago}}" data-presupuesto="{{$equipo->presupuesto}}"
                                 data-inversion="{{$equipo->inversion}}" data-id_servicio="{{$equipo->id_servicio}}"
                                 ...
                                 data-uniqueid="{{$equipo->uniqueid}}" data-id_comentario="{{$equipo->id_comentario}}"
                                 ...
                                 data-golpes="{{$equipo->Golpes}}" data-tiene_bateria="{{$equipo->Tiene_Bateria}}"><svg
                                     width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-pencil-square"
                                     fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                     <path
                                         d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                     <path fill-rule="evenodd"
                             ...
                             <a href="/deleteequipo/{{$equipo->id}}"><svg width="2em" height="2em" viewBox="0 0 16 16"
                             ...
                             <a href="" data-toggle="modal" data-target="#modal_foto" data-id="{{$equipo->id}}"
                                 ...
                                 data-id_user="{{$equipo->id_user}}" data-servicio="{{$equipo->id_servicio}}"
                             ...
                             <a href="" data-toggle="modal" data-target="#modal_pago" data-id="{{$equipo->id}}"
                                 data-presupuesto="{{$equipo->presupuesto}}" data-inversion="{{$equipo->inversion}}"
                                 data-pago="{{$equipo->pago}}" data-adelanto="{{$equipo->adelanto}}"
                                 data-modelo="{{$equipo->modelo}}" data-precio="{{$servicio->precio}}"
                             ...
                             <a type="button" class="btn btn-outline-dark" href="" data-toggle="modal"
                                 ...
                                 data-uniqueid="{{$equipo->uniqueid}}" data-fecha_recibido="{{$equipo->fecha_recibido}}"
                                 data-fecha_entrega="{{$equipo->fecha_entrega}}" data-status="{{$equipo->status}}">Mas
                                            ...
                                            <table class="table table-striped table-inverse table-responsive"
                                                ...
                                                <thead class="thead-inverse">
                                                    <tr>
                                                        ...
                                                        <th><button type="button" data-toggle="modal"
                                                                data-target="#modal_caja" data-backdrop="static"
                                                                data-keyboard="false"
                                                            ...
                                                            <button type="button" data-toggle="modal"
                                                                data-target="#modal_corte" data-backdrop="static"
                                                                data-keyboard="false"
