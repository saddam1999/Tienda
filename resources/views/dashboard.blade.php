        ...
        <div id="blurrMe">
            <div class="tab-content bg-black" id="myTabContent"
                ...
                <div class="row">
                    ...
                    <!---aqui empieza reinicio  caja--->
                    <div class="col-md-4 m-auto mt-1 mb-3">
                        <button name="taller_boton" id="taller_boton" type="button" data-toggle="modal"
                            data-target="#modalReinicio" data-backdrop="static" data-keyboard="false"
                            class="btn btn-warning btn-lg btn-block text-white mt-3"
                            style="vertical-align:middle"><span>Reinicio Caja<center><svg width="2em" height="2em"
                ...
                <div class="icon-bar fixed-bottom mb-5" style="border-radius:10px; margin-bottom:18%;" name="ocultar"
                    ...
                    <a onclick="closeNav()" class="nav-link face" id="usuarios-tab" data-toggle="tab" href="#usuarios"
                    ...
                    <a onclick="closeNav()" class="nav-link face" id="settings-tab" data-toggle="tab" href="#settings"
                        role="tab" aria-controls="settings"><svg width="1em" height="1em" viewBox="0 0 16 16"
