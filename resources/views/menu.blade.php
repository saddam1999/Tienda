<div class="sidebar closed" style="background-image: url('../img/backgrounds.jpeg');">
    <header>
        ...
        <h2 class="text-white">@if($Settings->isEmpty()) @else{{$setting->setting_nombre}}@endif</h2> <a href="#"
            id="close"><span class="entypo-cancel"></span></a>
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            <a onclick="closeNav()" class="nav-link" id="taller-tab" data-toggle="tab" href="#taller" role="tab"
                aria-controls="taller" aria-selected="false"><svg width="1em" height="1em" viewBox="0 0 16 16"
            ...
            </a> <a onclick="closeNav()" class="nav-link" id="usuarios-tab" data-toggle="tab" href="#usuarios"
                role="tab" aria-controls="usuarios" aria-selected="false"><svg width="1em" height="1em"
                    viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
            ...
            <a onclick="closeNav()" class="nav-link" id="sucursal-tab" data-toggle="tab" href="#sucursal" role="tab"
            ...
            <a class="ml-auto mr-auto" href="javascript:void(0)" onclick="closeNav()">&times;</a>
        </div>
