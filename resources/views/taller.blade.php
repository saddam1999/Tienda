                                    ...
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <button class="nav-link" id="nav-revision-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="nav-revision" aria-selected="false">En Revision <span
                                                class="badge bg-secondary">{{$revision}}</span></button>
                                        ...
                                        <button class="nav-link" id="nav-espera-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="nav-espera" aria-selected="false">Espera<span
                                                class="badge bg-secondary">{{$espera}}</span></button>
                                        ...
                                        <button class="nav-link" id="nav-cliente-tab" data-bs-toggle="tab"
                                            ...
                                            <span class="badge bg-secondary">{{$cliente}}</span></button>

                                        <button class="nav-link" id="nav-listo-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-listo" type="button" role="tab"
                                            aria-controls="nav-listo" aria-selected="false">Entregado <span
                                                class="badge bg-secondary">{{$entregado}}</span></button>
                                        ...
                                        <button class="nav-link" id="nav-cancelado-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="nav-cancelado" aria-selected="false">Cancelados<span
                                                class="badge bg-secondary">{{$cancelado}}</span></button>
                                    </div>
                                </small>
                                </nav>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if($equipo->status==1 || $equipo->status==3 ||
                                                            $equipo->status==4
                                                            ||
                                                            ...
                                                            <input class="text-info form-control" type="date"
                                                                value="{{$equipo->fecha_entrega}}">
                                                            <small class="text-success card-footer">faltan:
                                                                @if($diff->days>=1)
                                                                {{$diff->days .' dias'}} @else
                                                                {{$diff->days .' dia'}}@endif</small>
                                                            @endif
                                                            ...
                                                            <div class="card text-left">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                    ...
                                                                    class="bi bi-patch-check-fill text-success ml-auto mr-auto"
                                                                    viewBox="0 0 16 16">
                                                                    <path
                                                                ...
                                                                <h4 class="card-title text-info ml-auto mr-auto">
                                                                    Entregado</h4>
                                                                <p class="card-text ml-auto mr-auto">
                                                                    {{$equipo->fecha_entrega}}</p>
                                                            </div>
                                        </div>
                                        ...
                                        <small>
                                            <div class="card text-left">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor"
                                                    class="bi bi-patch-exclamation-fill text-danger ml-auto mr-auto"
                                                    viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    <td>
                                        <a class="custom-control-inline"
                                            ...
                                            data-Tiene_Bateria="{{$equipo->Tiene_Bateria}}"><i
                                                class="far fa-file-pdf text-warning h5 face"
                                                        ...
                                                        <div class="accordion-item text-white">
                                                            ...
                                                            <div id="collapseOne{{$equipo->id}}"
                                                                ...
                                                                <div class="accordion-body" style="width: 200px;">
                                                                    ...
                                                                    <a class=" d-inline " href="" data-toggle="modal"
                                                                        data-target="#modal_foto"
                                                                        data-id="{{$equipo->id}}"
                                                                        data-presupuesto="{{$equipo->presupuesto}}"
                                                                        data-inversion="{{$equipo->inversion}}"
                                                ...
                                                <div class="accordion-item text-white">
                                                    ...
                                                    <div id="collapseOne{{$equipo->id}}"
                                                        ...
                                                        <div class="accordion-body" style="width: 200px;">
                                                            ...
                                                            <a class=" d-inline "
                                                                href="/deleteequipo/{{$equipo->id}}"><svg width="2em"
                                                            ...
                                                            <a class=" d-inline " href="/galleria/{{$equipo->id}} "
                                                                target="_blank" data-id="{{$equipo->id}}"
                                                                data-presupuesto="{{$equipo->presupuesto}}"
                                                                data-inversion="{{$equipo->inversion}}"
                                                                data-id_user="{{$equipo->id_user}}"
                                                                ...
                                                                data-Tiene_Bateria="{{$equipo->Tiene_Bateria}}"><svg
                                                                    width="2em" height="2em" viewBox="0 0 16 16"
                                                                    class="bi bi-film text-warning" fill="currentColor"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
                                                                        d="M0 1a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V1zm4 0h8v6H4V1zm8 8H4v6h8V9zM1 1h2v2H1V1zm2 3H1v2h2V4zM1 7h2v2H1V7zm2 3H1v2h2v-2zm-2 3h2v2H1v-2zM15 1h-2v2h2V1zm-2 3h2v2h-2V4zm2 3h-2v2h2V7zm-2 3h2v2h-2v-2zm2 3h-2v2h2v-2z" />
                                                                </svg></a>
                                                            ...
                                                            <a class=" d-inline " href="" data-toggle="modal"
                                                                ...
                                                                data-id_sucursal="{{$equipo->id_sucursal}}"><svg
                                                                    width="2em" height="2em" viewBox="0 0 16 16"
                                                                    class="bi bi-cash text-info" fill="currentColor"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
                                                                        d="M15 4H1v8h14V4zM1 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H1z" />
                                                                    <path
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group-prepend ">
                                                <span class="input-group-text text-danger" id="basic-addon1"><svg
                                                        width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-alarm"
                                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd"
                                                            d="M6.5 0a.5.5 0 0 0 0 1H7v1.07a7.001 7.001 0 0 0-3.273 12.474l-.602.602a.5.5 0 0 0 .707.708l.746-.746A6.97 6.97 0 0 0 8 16a6.97 6.97 0 0 0 3.422-.892l.746.746a.5.5 0 0 0 .707-.708l-.601-.602A7.001 7.001 0 0 0 9 2.07V1h.5a.5.5 0 0 0 0-1h-3zm1.038 3.018a6.093 6.093 0 0 1 .924 0 6 6 0 1 1-.924 0zM8.5 5.5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5zM0 3.5c0 .753.333 1.429.86 1.887A8.035 8.035 0 0 1 4.387 1.86 2.5 2.5 0 0 0 0 3.5zM13.5 1c-.753 0-1.429.333-1.887.86a8.035 8.035 0 0 1 3.527 3.527A2.5 2.5 0 0 0 13.5 1z" />
                                                    </svg>
            ...
            <div class="tab-pane fade" id="nav-espera" role="tabpanel" aria-labelledby="nav-espera-tab">
                <div class="table-responsive">
                    ...
                    <table class="table" id="tabletaller">
                        ...
                        <tbody>
                            @foreach($Equipo->sortByDesc('id') as $equipo)
                            @if($equipo->id_sucursal==Auth::user()->id_sucursal&&$equipo->status==3)
                            <tr>
                                <td>
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item text-white">
                                            ...
                                            <div id="collapseOne{{$equipo->id}}"
                                                ...
                                                <div class="accordion-body" style="width: 200px;">
                                                    ...
                                                    <a class=" d-inline " href="/deleteequipo/{{$equipo->id}}"><svg
                                                            width="2em" height="2em" viewBox="0 0 16 16"
                                                            class="bi bi-trash" fill="currentColor"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
    ...
    <div class="tab-pane fade" id="nav-cliente" role="tabpanel" aria-labelledby="nav-cliente-tab">
        <div class="table-responsive">
            ...
            <table class="table" id="tabletaller">
                ...
                <tbody>
                    @foreach($Equipo->sortByDesc('id') as $equipo)
                    @if($equipo->id_sucursal==Auth::user()->id_sucursal&&$equipo->status==4)
                    <tr>
                        <td>
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item text-white">
    ...
    <div class="tab-pane fade" id="nav-revision" role="tabpanel" aria-labelledby="nav-revision-tab">
        <div class="table-responsive">
            <table class="table" id="tabletaller">
                ...
                <tbody>
                    @foreach($Equipo->sortByDesc('id') as $equipo)
                    @if($equipo->id_sucursal==Auth::user()->id_sucursal&&$equipo->status==1)
                    <tr>
                        <td>
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item text-white">
                            ...
                            <div class="accordion-item text-white">
                                ...
                                <div id="collapseOne{{$equipo->id}}" class="accordion-collapse collapse text-white "
                                    ...
                                    <div class="accordion-body" style="width: 200px;">
                                        ...
                                        <a class=" d-inline " href="/deleteequipo/{{$equipo->id}}"><svg width="2em"
                                                height="2em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                                                <path fill-rule="evenodd"
                                        ...
                                        <a class=" d-inline " href="" data-toggle="modal" data-target="#modal_pago"
                                            ...
                                            data-id_cliente="{{$equipo->id_cliente}}" data-serial="{{$equipo->serial}}"
                                            data-imei="{{$equipo->imei}}"
                                            data-id_sucursal="{{$equipo->id_sucursal}}"><svg width="2em" height="2em"
                                                viewBox="0 0 16 16" class="bi bi-cash text-info" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M15 4H1v8h14V4zM1 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H1z" />
                                                <path
    ...
    <small>
        ...
        <td>
            <a class="custom-control-inline" href="/imprimir/id={{$equipo->id}}&csrf={{ csrf_token() }}" target="_blank"
                ...
                data-id_user="{{$equipo->id_user}}" data-id_cliente="{{$equipo->id_cliente}}"
                data-serial="{{$equipo->serial}}" data-imei="{{$equipo->imei}}"
                data-id_captura="{{$equipo->id_captura}}" data-id_comentario="{{$equipo->id_comentario}}"
                data-fecha_recibido="{{$equipo->fecha_recibido}}" data-fecha_entrega="{{$equipo->fecha_entrega}}"
                ...
                data-Auricular="{{$equipo->Auricular}}" data-Touch="{{$equipo->Touch}}"
                data-Bateria="{{$equipo->Bateria}}" data-Enciende="{{$equipo->Enciende}}"
                data-Memoria="{{$equipo->Memoria}}" data-SIM="{{$equipo->SIM}}" data-Golpes="{{$equipo->Golpes}}"
                data-Tiene_Bateria="{{$equipo->Tiene_Bateria}}"><i class="far fa-file-pdf text-warning h5 face"
                    alt="Imprime archivo PDF"></i></a>
            <a href="/QR/{{$equipo->id}}" target="_blank">
                <h5><i class="fas fa-qrcode face" alt="Imprime QR"></i>
