                                                ...
                                                <td>
                                                    ...
                                                    @elseif($equipo->status==6)
                                                        <div class="card text-left">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-check-fill text-success ml-auto mr-auto" viewBox="0 0 16 16">
                                                    ...
                                                    <small>
                                                        <div class="card text-left">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-exclamation-fill text-danger ml-auto mr-auto" viewBox="0 0 16 16">
