...
<body>
    ...
    <header>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-header" id="smartcart">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="#">
                        <img src="https://i.pinimg.com/736x/89/10/8e/89108e533640fd9d0731e0623699c57c.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
  ...
  ================================================== -->
                            ...
                            <tr class="sc-product-item">
                                <td>
                                        ...
                                        <img data-name="product_image"
                                            src="http://placehold.it/250x150/2aabd2/ffffff?text=Product+1" alt="...">
                                </td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalvender" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
            aria-hidden="true">
                                    ...
                                    <table class="table table-striped table-inverse table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="sc-product-item">
                                                ...
                                                <!-- PRODUCT PRICE, identified by name="product_price" or can be an element with data-name="product_price"-->
                                                <td><input name="product_price" value="{{$servicio->precio}}"
                                                        type="hidden" />
                                                </td>
                                                <!-- PRODUCT ID, identified by name="product_id" or can be an element with data-name="product_id"-->
                                                <td> <input name="product_id" value="{{$servicio->id}}" type="hidden" />
                                                </td>
                                                <!-- ADD TO CART BUTTON, identified by class="sc-add-to-cart"  -->
                                                <td> <button class="sc-add-to-cart btn btn-success">Agregar
                                                        Carrito</button>
                                                </td>
                                </div>
                                <!-- END PRODUCT CONTAINER 1 -->
