...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="demo_images/ico/apple-touch-icon-144.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="demo_images/ico/apple-touch-icon-114.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="demo_images/ico/apple-touch-icon-72.png">
    <link rel="apple-touch-icon-precomposed" href="demo_images/ico/apple-touch-icon-57.png">
    <link rel="shortcut icon" href="demo_images/ico/favicon.png">
    <!--[if IE]><![endif]-->
    <link rel="stylesheet" href="demo_css/style.css">
    <script src="demo_js/jquery.js"></script>
    <script src="demo_js/countdown.js"></script>
    <script src="demo_js/owlcarousel.js"></script>
    <script src="demo_js/uikit.scrollspy.js"></script>
    <script src="demo_js/scripts.js"></script>
...
<body id="backtotop">
    ...
    <div class="fullwidth colour2 clearfix">
        <div id="maincont" class="bodycontainer clearfix"
            ...
            <p><strong>Lorem ipsum dolor</strong> sit amet, consectetur adipiscing elit. <a title="" href="#">Donec quis
                    enim nulla</a>. Suspendisse posuere arcu ac eros iaculis egestas commodo risus tempus. Fusce
                placerat nulla nisi. Proin congue erat non orci adipiscing nec porttitor lacus egestas. <em>Donec
                    venenatis</em>, risus et hendrerit ultrices, libero sem lacinia risus, ut convallis massa sapien nec
                libero. Suspendisse arcu orci, gravida nec aliquet ut, lacinia non nisl.</p>
    ...
    <div class="fullwidth colour3 clearfix">
        <div id="quotecont" class="bodycontainer clearfix"
            ...
            <div id="commentslider" class="owl-carousel">
                <div class="item">
                    <p>"<strong>Lorem ipsum dolor</strong> sit amet, consectetur adipiscing elit. Donec quis enim nulla.
                        <em>Suspendisse posuere</em> arcu ac eros iaculis egestas commodo risus tempus. Fusce placerat
                        nulla nisi. Proin congue erat non orci adipiscing nec porttitor lacus egestas."</p>
                    <p class="author">- Andrew Smith</p>
                </div>
                <div class="item">
                    <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. <strong>Donec quis enim</strong> nulla.
                        Suspendisse posuere arcu ac eros iaculis egestas commodo risus tempus. <em>Fusce placerat nulla
                            nisi</em>."</p>
                    <p class="author">- Laura Roberts</p>
                </div>
                <div class="item">
                    <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. <strong>Donec quis enim</strong> nulla.
                        Suspendisse posuere arcu ac eros iaculis egestas commodo risus tempus. <em>Fusce placerat</em>
                        nulla nisi. Proin congue erat non orci adipiscing nec <strong>porttitor</strong> lacus egestas."
                    </p>
    ...
    <div class="fullwidth clearfix">
        <div id="footercont" class="bodycontainer clearfix"
            ...
            <p>HollyDev<a title="website template" href="https://www.hollyrenew.website" rel="external">Website
                    Template</a> - Icons by <a title="" href="https://fortawesome.github.io/Font-Awesome/"
                    rel="external">HollyRenew</a></p>
        </div>
    </div>
    ...
    <div id="page-wrapper">
        ...
        <div id="header-wrapper"
            ...
            <div class="container">
                ...
                <header id="header">
                    <div class="container">
                        <div class="header-row py-2 bg-warning text-white"
                            style="color:#fff; border-radius:10px 10px 0px 0px;">
                                        ...
                                        <ul class="nav nav-pills">
                                            <li class="nav-item ml-2 mr-2">
                                                <a class=" text-white strong"
                                                    href="mailto:@if($Settings->isEmpty()) @else {{$setting->setting_contacto}} @endif"><i
                                                        class="far fa-envelope text-white"
                                                        style="top: 1px;"></i>:@if($Settings->isEmpty()) @else
                                                    {{$setting->setting_contacto}} @endif </a>
                                            </li>
                                            <li class="nav-item ml-2">
                                                <a class=" text-white strong"
                                                    href="tel:@if($Settings->isEmpty()) @else {{$setting->setting_telefono}} @endif"><i
                                                        class="fab fa-whatsapp  text-white"
                                                        style="top: 0;"></i>:@if($Settings->isEmpty()) @else
                                                    {{$setting->setting_telefono}} @endif</a>
                                            </li>
                                            <li class="nav-item ml-2">
                                                <a class=" text-white" href="#" data-toggle="modal"
                                                    data-target="#modal_ubicacion"><i
                                                        class="fas fa-map-marker-alt"></i>: @if($Settings->isEmpty())
                                                    @else {{$setting->setting_direccion}} @endif</a>
                                            </li>
                                            <li class="nav-item ml-2">
                                                <a class=" text-white strong"
                                                    href="tel:@if($Settings->isEmpty()) @else {{$setting->setting_abierto}}"
                                                    @endif><i class="fab fa-algolia"></i>: @if($Settings->isEmpty())
                                                    @else {{$setting->setting_abierto}} @endif</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                    ...
                    <div class="inner">
                        ...
                        <a class="navbar-brand" href="/">
                            <img style="border-radius:70%;"
                                src=" @if($Settings->isEmpty()) @else {{$setting->setting_logo}}@endif" width="70"
                ...
                <div id="banner">
                    <h2>
                        <br />
                        <a href="#" class="button large icon solid fa-check-circle"><strong>@if($Settings->isEmpty())
                                @else {{$setting->setting_nombre}}@endif</strong></a></h2>
                </div>
        ...
        <section class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 bg-warning" style="border-radius:4px;">
                        <h1 class="text-white">ARTICULOS MÁS VENDIDOS</h1>
                    </div>
                        ...
                        <div class="bbb_deals sc-product-item mt-3" style="border-radius:40px;">
                            ...
                            <div class="bbb_deals_slider_container">
                                <div class=" bbb_deals_item">
                                    <div class="bbb_deals_image thumbnail zoom"><img style="border-radius: 10px;"
                                    ...
                                    <div class="bbb_deals_content">
                                        <div class="bbb_deals_info_line d-flex flex-row justify-content-start">
                                            ...
                                            <div class="bbb_deals_item_category"><a href="#">{{$marca->nombre}}</a>
                                            </div>
                                            @endif
                                            @endforeach
                                        ...
                                        <div class="available">
                                            ...
                                            <button class="sc-add-to-cart btn btn-success btn-animate">Agregar
                                                Carrito</button>
        ...
        <section class="container">
            <section>
                <div class="container marketing">
                    <div class="row">
                        <div class="col-md-12 bg-success" style="border-radius:4px;">
                            <h1 class="text-white"> @if($Promocion->isEmpty()) @else
                                {{$promocion->titulo}} @endif</h1>
                        </div>
                        <!-- BEGIN PRODUCTS -->
                        @foreach ($Articulo as $producto)
                        @if($producto->descuento!=0)
                    ...
                    <section class="box spotlight">
                        ...
                        <article>
                            ...
                            <p>Desbloqueo oficial de fábrica para cualquier iPhone, independientemente de la
                                ...
                                complicado.</p>
                            <footer>
                                <a href="#" class="button alt icon solid fa-file-alt">Arriba</a>
                            </footer>
                        </article>
                    </section>
