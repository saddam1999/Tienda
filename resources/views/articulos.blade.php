                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingOne">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        data-bs-target="#articulo{{$articulo->id}}" aria-expanded="true"
                                                        aria-controls="collapseOne">Opciones</button>
                                                </h2>
                                                <div id="articulo{{$articulo->id}}" class="accordion-collapse collapse"
