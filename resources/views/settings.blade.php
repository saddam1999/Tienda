                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="nav flex-column nav-pills bg-white" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
                                role="tab" aria-controls="v-pills-profile" aria-selected="false">Promociones </a>
                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-usuario"
                                role="tab" aria-controls="v-pills-messages" aria-selected="false">Usuarios</a>
                            <a class="nav-link" id="v-pills-sucursal-tab" data-toggle="pill" href="#v-pills-sucursal"
                                role="tab" aria-controls="v-pills-sucursal" aria-selected="false">Sucursales</a>
                            <a class="nav-link" id="v-pills-caja-tab" data-toggle="pill" href="#v-pills-caja" role="tab"
                    ...
                    <div class="col-md-10">
                        <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="../images/template1.png" @if($Settings->isEmpty())
                                                        @else
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="setting_plantilla" id="setting_plantilla"
                                                            value="../images/template2.png" @if($Settings->isEmpty())
                                                        @else
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="setting_plantilla" id="setting_plantilla"
                                                            value="../images/template3.png" @if($Settings->isEmpty())
                                                        @else
                            ...
                            <div class="tab-pane fade" id="v-pills-usuario" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="v-pills-sucursal" role="tabpanel"
                                aria-labelledby="v-pills-sucursal-tab">
                                @include('sucursal')
                            </div>
                            <div class="tab-pane fade" id="v-pills-caja" role="tabpanel"
