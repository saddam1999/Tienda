                    ...
                    <div class="container">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#promociones"
                                    data-toggle="tab">Promociones</a></li>
                            <li class="nav-item"><a class="nav-link" href="#usuarios" data-toggle="tab">Usuarios</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#sucursales" data-toggle="tab">Sucursales</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#cajas" data-toggle="tab">Cajas</a></li>
                            <li class="nav-item"><a class="nav-link" href="#notificaciones"
                                    data-toggle="tab">Notificaciones</a></li>
                        </ul>
                    </div>
