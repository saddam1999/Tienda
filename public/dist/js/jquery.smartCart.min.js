...
! function(t, e, a, i) {
    ...
    function s(e, a) { this.options = t.extend(!0, {}, r, a), this.cart = [], this.cart_element = t(e), this.init() }
    var r = { cart: [], resultName: "cart_list", theme: "default", combineProducts: !0, highlightEffect: !0, cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h4 class="list-group-item-heading text-dark">{product_name}</h4><p class="list-group-item-text" style="color:black;">{product_desc}</p>', cartItemQtyTemplate: "{display_price} × {display_quantity} = {display_amount}", productContainerSelector: ".sc-product-item", productElementSelector: "*", addCartSelector: ".sc-add-to-cart", paramSettings: { productPrice: "product_price", productQuantity: "product_quantity", productName: "product_name", productId: "product_id" }, lang: { cartTitle: "Shopping Cart", checkout: "Checkout", clear: "Clear", subtotal: "Subtotal:", cartRemove: "×", cartEmpty: "Cart is Empty!<br />Choose your products" }, submitSettings: { submitType: "form", ajaxURL: "", ajaxSettings: {} }, currencySettings: { locales: "en-US", currencyOptions: { style: "currency", currency: "MXN", currencyDisplay: "symbol" } }, toolbarSettings: { showToolbar: !0, showCheckoutButton: !0, showClearButton: !0, showCartSummary: !0, checkoutButtonStyle: "default", checkoutButtonImage: "", toolbarExtraButtons: [] }, debug: !1 };
    t.extend(s.prototype, {
        init: function() {
            this._setElements(), this._setToolbar(), this._setEvents();
            var e = this;
            t(this.options.cart).each(function(t, a) { a = e._addToCart(a) }), this._hasCartChange()
        },
        ...
        _setToolbar: function() {
            ...
            var e = t("<div></div>").addClass("panel-footer sc-toolbar"),
                a = t('<div class="sc-cart-toolbar text-dark">'),
                i = t('<div class="sc-cart-summary text-dark">');
        ...
        _setEvents: function() {
            ...
            }), t(this.cart_element).on("click", ".sc-cart-remove", function(a) { a.preventDefault(), t(this).parents(".sc-cart-item").fadeOut("normal", function() { e._removeFromCart(t(this).data("unique-key")), t(this).remove(), e._hasCartChange() }) }), t(this.cart_element).on("change", ".sc-cart-item-qty", function(a) { a.preventDefault(), e._updateCartQuantity(t(this).parents(".sc-cart-item").data("unique-key"), t(this).val()) }), t(this.cart_element).on("click", ".sc-cart-checkout", function(a) {
                if (t(this).hasClass("disabled")) return !1;
                a.preventDefault(), e._submitCart()
            }), t(this.cart_element).on("click", ".sc-cart-clear", function(a) {
                if (t(this).hasClass("disabled")) return !1;
                a.preventDefault(), t(".sc-cart-item-list > .sc-cart-item", this.cart_element).fadeOut("normal", function() { t(this).remove(), e._clearCart(), e._hasCartChange() })
            })
        },
        ...
        _removeFromCart: function(e) {
            var a = this;
            t.each(this.cart, function(i, s) { if (s.unique_key === e) { var r = a.cart[i]; return a.cart.splice(i, 1), t('*[data-product-unique-key="' + e + '"]').removeClass("sc-added-item"), a._hasCartChange(), this._triggerEvent("itemRemoved", [r]), !1 } })
        },
        _clearCart: function() { this.cart = [], this._triggerEvent("cartCleared"), this._hasCartChange() },
        _updateCartQuantity: function(e, a) {
            var i = this,
                s = this._getValidateNumber(a);
            t.each(this.cart, function(t, r) { if (r.unique_key === e) return s && (i.cart[t][i.options.paramSettings.productQuantity] = a), i._addUpdateCartItem(i.cart[t]), this._triggerEvent("quantityUpdated", [i.cart[t], a]), !1 })
        },
        ...
        _getCartSubtotal: function() {
            var e = this,
                a = 0;
            return t.each(this.cart, function(t, i) { e._getValidateNumber(i[e.options.paramSettings.productPrice]) && (a += (i[e.options.paramSettings.productPrice] - 0) * (i[e.options.paramSettings.productQuantity] - 0)) }), this._getMoneyFormatted(a)
        },
