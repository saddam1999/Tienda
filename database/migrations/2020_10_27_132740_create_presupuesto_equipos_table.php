...
class CreatePresupuestoEquiposTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('presupuesto_equipos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('presupuesto_equipos');
    }
}
